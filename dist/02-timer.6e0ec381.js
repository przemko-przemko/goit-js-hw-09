...
const countdown = () => {
  idTime = setInterval(() => {
    ...
    if (convertMs(timeMiliSecond).days === 0 && convertMs(timeMiliSecond).hours === 0 && convertMs(timeMiliSecond).minutes === 0 && convertMs(timeMiliSecond).seconds === 0) {
      clearInterval(idTime);
    }
  }, 1000);
};

const fail = () => _notiflix.default.Notify.failure('Button in progress');

btnStart.addEventListener('click', countdown);
btnStop.addEventListener('click', fail);
(0, _flatpickr.default)(initDate, options);
},{"flatpickr":"../node_modules/flatpickr/dist/esm/index.js","flatpickr/dist/flatpickr.min.css":"../node_modules/flatpickr/dist/flatpickr.min.css","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.1.0.min.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
